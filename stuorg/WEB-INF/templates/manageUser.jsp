...
<!-- 置顶的标签导航条 -->
	...
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a
				href="/dep/toManageDep?orgId=${org.orgId }">${org.orgName}部门管理</a></li>
			<li class="breadcrumb-item active">管理<span>${org.orgName }${dep.depName}</span>成员
			</li>
		</ol>
	</nav>
					...
					<tbody>
						<c:forEach items="${requestScope.userList}" var="user"
							...
							<tr>
								...
								<td>
								<!-- 删除按钮 -->
									<a href="/user/delUser?userId=${user.userId }&depId=${dep.depId}&orgId=${org.orgId}"
  ...
  <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z" clip-rule="evenodd"/>
									...
									<!-- 更改按钮 -->
									 <a href="/user/toUpdateUser?userId=${user.userId }&depId=${dep.depId}&orgId=${org.orgId}">
